...
@Component({
  ...
  imports: [Form, PricingCard, Preferences, Notification, SummaryCard, ProfileCard, ActivityFeed, RowCard, StatusCard, UploadCard, HighlightCard, ToggleCard, OnboardingCard, RoleCard, NotificationCard, MetadataCard, InfobannerCard],
